...
abstract class CustomDeliverySlice implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CustomDelivery\\Model\\Map\\CustomDeliverySliceTableMap';
    ...
    /**
     * Initializes internal state of CustomDelivery\Model\Base\CustomDeliverySlice object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>CustomDeliverySlice</code> instance.  If
     * <code>obj</code> is an instance of <code>CustomDeliverySlice</code>, delegates to
     * <code>equals(CustomDeliverySlice)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return CustomDeliverySlice The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[CustomDeliverySliceTableMap::ID] = true;
        }
    ...
    public function setAreaId($v)
    {
        ...
        if ($this->area_id !== $v) {
            $this->area_id = $v;
            $this->modifiedColumns[CustomDeliverySliceTableMap::AREA_ID] = true;
        }
    ...
    public function setPriceMax($v)
    {
        ...
        if ($this->price_max !== $v) {
            $this->price_max = $v;
            $this->modifiedColumns[CustomDeliverySliceTableMap::PRICE_MAX] = true;
        }
    ...
    public function setWeightMax($v)
    {
        ...
        if ($this->weight_max !== $v) {
            $this->weight_max = $v;
            $this->modifiedColumns[CustomDeliverySliceTableMap::WEIGHT_MAX] = true;
        }
    ...
    public function setPrice($v)
    {
        ...
        if ($this->price !== $v) {
            $this->price = $v;
            $this->modifiedColumns[CustomDeliverySliceTableMap::PRICE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CustomDeliverySliceTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CustomDeliverySliceTableMap::translateFieldName('AreaId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCustomDeliverySliceQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildCustomDeliverySliceQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CustomDeliverySliceTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CustomDeliverySliceTableMap::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(CustomDeliverySliceTableMap::AREA_ID)) {
            $modifiedColumns[':p' . $index++]  = 'AREA_ID';
        }
        if ($this->isColumnModified(CustomDeliverySliceTableMap::PRICE_MAX)) {
            $modifiedColumns[':p' . $index++]  = 'PRICE_MAX';
        }
        if ($this->isColumnModified(CustomDeliverySliceTableMap::WEIGHT_MAX)) {
    ...
    {
        $pos = CustomDeliverySliceTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CustomDeliverySlice'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CustomDeliverySlice'][$this->getPrimaryKey()] = true;
        $keys = CustomDeliverySliceTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CustomDeliverySliceTableMap::ID)) $criteria->add(CustomDeliverySliceTableMap::ID, $this->id);
        if ($this->isColumnModified(CustomDeliverySliceTableMap::AREA_ID)) $criteria->add(CustomDeliverySliceTableMap::AREA_ID, $this->area_id);
    ...
    {
        $criteria = new Criteria(CustomDeliverySliceTableMap::DATABASE_NAME);
        $criteria->add(CustomDeliverySliceTableMap::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CustomDelivery\Model\CustomDeliverySlice (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \CustomDelivery\Model\CustomDeliverySlice Clone of current object.
     * @throws PropelException
     */
    ...
    public function getArea(ConnectionInterface $con = null)
    {
        if ($this->aArea === null && ($this->area_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aArea->addCustomDeliverySlices($this);
             */
        }
